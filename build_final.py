...
/* Header */
.hdr{{display:flex;align-items:center;gap:8px;padding:12px 16px;min-height:50px;background:rgba(0,0,0,.35);backdrop-filter:blur(40px);-webkit-backdrop-filter:blur(40px);border-bottom:1px solid rgba(255,255,255,.03);z-index:10}}
...
.msg.a .b{{background:rgba(255,255,255,.05);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.03);border-bottom-left-radius:3px;color:var(--t)}}
...
.inp-i{{display:flex;align-items:flex-end;gap:6px;background:rgba(255,255,255,.06);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.07);border-radius:22px;padding:3px 3px 3px 14px;transition:.2s}}
...
.set{{position:fixed;left:0;bottom:0;width:100%;max-height:85dvh;background:rgba(28,28,32,.96);backdrop-filter:blur(50px);-webkit-backdrop-filter:blur(50px);border-radius:22px 22px 0 0;z-index:101;transform:translateY(100%);transition:.45s cubic-bezier(.32,.72,0,1);overflow-y:auto;padding:20px}}
...
/* Sidebar */
.side{{position:fixed;left:0;top:0;bottom:0;width:260px;background:rgba(20,20,26,.98);backdrop-filter:blur(40px);-webkit-backdrop-filter:blur(40px);z-index:90;transform:translateX(-100%);transition:.4s cubic-bezier(.32,.72,0,1);display:flex;flex-direction:column;border-right:1px solid rgba(255,255,255,.04)}}
...
.side-i.a{{background:rgba(255,255,255,.07);color:var(--t)}}
...
.so input:focus{{border-color:rgba(102,126,234,.3)}}
.so .sr{{flex:1;overflow-y:auto;margin-top:10px}}
.sri{{padding:10px 12px;border-radius:8px;background:rgba(255,255,255,.03);cursor:pointer;font-size:12px;color:var(--t2);margin-bottom:3px;transition:.12s}}
.sri:hover{{background:rgba(255,255,255,.06)}}

/* Shortcuts modal */
.sh{{position:absolute;inset:0;z-index:60;background:rgba(0,0,0,.8);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);display:none;flex-direction:column;align-items:center;justify-content:center;padding:40px}}
.sh.s{{display:flex}}
...
.sh .c h2{{font-size:16px;font-weight:600;margin-bottom:14px;letter-spacing:-.3px}}
.sr2{{display:flex;align-items:center;justify-content:space-between;padding:6px 0;font-size:12px;color:var(--t2);border-bottom:1px solid rgba(255,255,255,.03);font-family:inherit}}
...
/* Playground */
.pg{{position:absolute;inset:0;z-index:55;background:rgba(0,0,0,.93);backdrop-filter:blur(30px);-webkit-backdrop-filter:blur(30px);display:none;flex-direction:column;padding:14px}}
.pg.s{{display:flex}}
.pg-t{{display:flex;gap:4px;margin-bottom:8px}}
.pg-t button{{padding:5px 12px;border-radius:7px;border:none;background:rgba(255,255,255,.04);color:var(--t2);font-size:11px;cursor:pointer;font-family:inherit;transition:.12s}}
...
/* Context menu */
.ctx{{position:fixed;z-index:150;background:rgba(28,28,32,.96);backdrop-filter:blur(30px);-webkit-backdrop-filter:blur(30px);border-radius:12px;border:1px solid rgba(255,255,255,.05);padding:4px;min-width:140px;display:none;box-shadow:0 8px 32px rgba(0,0,0,.5)}}
.ctx.s{{display:block}}
...
@media(prefers-color-scheme:light){{
  ...
  .hdr{{background:rgba(255,255,255,.7)}}
  .msg.a .b{{background:rgba(255,255,255,.7);border-color:rgba(0,0,0,.05)}}
  .inp-i{{background:rgba(255,255,255,.8);border-color:rgba(0,0,0,.08)}}
  .inp-i textarea::placeholder{{color:#aaa}}
  .set{{background:rgba(245,245,247,.96)}}
  .mbar{{background:#e5e5ea}}
  .mbar select{{background-color:rgba(0,0,0,.05);color:#000}}
  .side{{background:rgba(245,245,247,.98)}}
  .toast{{background:rgba(245,245,247,.94);color:#000}}
  .sh .c{{background:rgba(245,245,247,.96)}}
  .ctx{{background:rgba(245,245,247,.96)}}
  .tg button.a{{border-color:#000}}
}}

/* Responsive */
@media(max-width:400px){{
  .hdr{{padding:8px 12px;min-height:44px}}
  .hdr h1{{font-size:14px}}
  .mbar{{padding:4px 12px}}
  .mbar select{{min-width:90px;font-size:11px}}
  .msgs{{padding:8px 10px 4px}}
  .msg .b{{padding:7px 10px;font-size:13px}}
  .inp-w{{padding:4px 10px 10px}}
  .inp-i textarea{{font-size:15px}}
  .inp-i{{border-radius:18px;padding:2px 2px 2px 10px}}
  .welcome{{padding:24px 14px 14px}}
  .welcome .ic{{width:48px;height:48px;font-size:22px}}
}}
</style>
</head>
<body>
...
<div class="set" id="set">
  ...
  <div class="sg"><label>Default Model</label><select id="sM">{MO}</select></div>
...
// Strip any non-ASCII from URL on load
